...
CTRL_SUBJECTS_F = f'{OUT}/ewang163_psych_control_subjects.txt'
CTRL_NOTES_F    = f'{OUT}/ewang163_psych_control_notes.parquet'
BEST_DIR        = f'{OUT}/ewang163_specificity_longformer_best'
EVAL_JSON       = f'{OUT}/ewang163_specificity_eval_results.json'
