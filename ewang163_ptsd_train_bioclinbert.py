...
BEST_DIR    = f'{OUT}/ewang163_bioclinbert_best'
LOG_CSV     = f'{OUT}/ewang163_bioclinbert_training_log.csv'
EVAL_JSON   = f'{OUT}/ewang163_bioclinbert_eval_results.json'

# Longformer predictions for McNemar comparison
LF_PRED_CSV = f'{OUT}/ewang163_longformer_test_predictions.csv'
...
def main():
    ...
    pred_csv = f'{OUT}/ewang163_bioclinbert_test_predictions.csv'
