...
PTSD_SIDS_F   = f'{DATA_COHORT}/ewang163_ptsd_subjects.txt'
PROXY_SIDS_F  = f'{DATA_COHORT}/ewang163_proxy_subjects.txt'
UNLAB_SIDS_F  = f'{DATA_COHORT}/ewang163_unlabeled_subjects.txt'

OUT_CSV     = f'{DATA_COHORT}/ewang163_ptsd_adm_extract.csv'
OUT_PARQUET = f'{DATA_COHORT}/ewang163_ptsd_adm_extract.parquet'
