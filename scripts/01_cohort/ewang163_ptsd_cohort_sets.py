...
def main():
    ...
    save_subjects(f'{DATA_COHORT}/ewang163_ptsd_subjects.txt', ptsd_subjects)
    save_subjects(f'{DATA_COHORT}/ewang163_proxy_subjects.txt', proxy_subjects)
    save_subjects(f'{DATA_COHORT}/ewang163_unlabeled_subjects.txt', unlab_subjects)
