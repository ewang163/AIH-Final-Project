...
LOGREG_PKL    = f'{MODEL_DIR}/ewang163_structured_logreg.pkl'
FEATURES_JSON = f'{MODEL_DIR}/ewang163_structured_features.json'
RESULTS_TXT   = f'{RESULTS_METRICS}/ewang163_structured_val_results.txt'
