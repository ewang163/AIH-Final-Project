...
PRED_CSV      = f'{OUT}/ewang163_longformer_test_predictions.csv'
ADM_PARQUET   = f'{OUT}/ewang163_ptsd_adm_extract.parquet'
TFIDF_PKL     = f'{OUT}/ewang163_tfidf_vectorizer.pkl'

FP_TXT        = f'{OUT}/ewang163_fp_notes_sample.txt'
FN_TXT        = f'{OUT}/ewang163_fn_notes_sample.txt'
SUMMARY_CSV   = f'{OUT}/ewang163_error_analysis_summary.csv'
