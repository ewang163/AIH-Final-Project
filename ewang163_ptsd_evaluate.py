...
LONGFORMER_DIR    = f'{OUT}/ewang163_longformer_best'
BIOCLINBERT_DIR   = f'{OUT}/ewang163_bioclinbert_best'   # may not exist
TFIDF_VEC_PKL     = f'{OUT}/ewang163_tfidf_vectorizer.pkl'
TFIDF_LR_PKL      = f'{OUT}/ewang163_tfidf_logreg.pkl'
STRUCT_LR_PKL     = f'{OUT}/ewang163_structured_logreg.pkl'
STRUCT_FEAT_JSON  = f'{OUT}/ewang163_structured_features.json'

DIAGNOSES_F       = f'{MIMIC}/hosp/3.1/diagnoses_icd.csv'
PRESCRIPTIONS_F   = f'{MIMIC}/hosp/3.1/prescriptions.csv'

RESULTS_JSON = f'{OUT}/ewang163_evaluation_results.json'
SUMMARY_CSV  = f'{OUT}/ewang163_evaluation_summary.csv'
